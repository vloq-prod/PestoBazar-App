...
import { useShipping } from "../../src/hooks/contentHooks";
...
export default function ShippingScreen() {
  ...
  return (
    ...
    >
      ...
      <AppNavbar title="Shipping & Cancellation" showBack />
        ...
        >
          ...
          <View style={styles.header}>
            <Text style={[styles.headerTitle, { color: colors.text }]}>
              {policyData?.title || "Shipping & Cancellation"}
            </Text>
          ...
          <View style={[styles.contactCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            ...
            <Text style={[styles.contactDesc, { color: colors.textSecondary }]}>
              If you have any questions about shipping or cancellation, feel free to reach us.
            </Text>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              onPress={() => Linking.openURL("mailto:support@pestobazaar.com")}
            >
              <View style={[styles.contactIcon, { backgroundColor: colors.border }]}>
                <Mail size={16} color={colors.textSecondary} />
              </View>
              <Text style={[styles.contactText, { color: colors.textSecondary }]}>
                support@pestobazaar.com
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              style={styles.contactRow}
              activeOpacity={0.7}
              onPress={() => Linking.openURL("https://www.pestobazaar.com")}
            >
              <View style={[styles.contactIcon, { backgroundColor: colors.border }]}>
