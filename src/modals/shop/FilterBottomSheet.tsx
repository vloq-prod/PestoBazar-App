...
interface Props {
  onApply?: (filters: { categories: number[]; brands: number[] }) => void;
}
  ...
  return (
    <View className="gap-2.5">
      <Text
        ...
        style={{ fontFamily: "Poppins_600SemiBold", color: colors.textSecondary }}
      >
        {title}
      </Text>
    ...
    return (
      ...
      >
        ...
        <View
          ...
          style={{ borderBottomColor: stableColors.border, backgroundColor: stableColors.primary }}
        >
          <Text
            className="text-[17px]"
        ...
        >
          ...
          <View
            ...
            style={{ backgroundColor: stableColors.border }}
          />
